...
$data4='';
$data5='';
$reponse_ancienne = $bdd->query('SELECT saison FROM performance, nageur where nageur.nom=performance.nom and nageur.prenom=performance.prenom and nageur.birth_date=performance.birth_date and type_course = \''.$test2.'\' and sexe=\'F\' order by saison limit 1;');

$reponse_recente = $bdd->query('SELECT saison FROM performance, nageur where nageur.nom=performance.nom and nageur.prenom=performance.prenom and nageur.birth_date=performance.birth_date and type_course = \''.$test2.'\' and sexe=\''.$test1.'\' order by saison desc limit 1;');
...
{
$reponse_meilleursaison = $bdd->query('SELECT min(TIME_TO_SEC(temps)) from nageur, performance where nageur.nom=performance.nom and nageur.prenom=performance.prenom and nageur.birth_date=performance.birth_date and type_course = \''.$test2.'\' and sexe=\''.$test1.'\' and saison='.$saison.';');
...
for ( $saison=$anneeancienne; $saison<$anneerecente+1; $saison++)
{
$reponse_meilleursaison = $bdd->query('SELECT avg(TIME_TO_SEC(temps)) from nageur, performance where nageur.nom=performance.nom and nageur.prenom=performance.prenom and nageur.birth_date=performance.birth_date and type_course = \''.$test2.'\' and sexe=\''.$test1.'\' and saison='.$saison.';');
while($donnees_meilleursaison = $reponse_meilleursaison->fetch())
{
